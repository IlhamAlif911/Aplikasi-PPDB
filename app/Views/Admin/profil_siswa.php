...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <div class="header-title">
          <h4 class="card-title">Ubah Data Pendaftar</h4>
        </div>
      </div>
      <div class="card-body">
    ...
    <!-- form -->
    <form method="post" enctype="multipart/form-data" action="<?= base_url(); ?>/update-profil/<?= $pendaftar->id_ref ?>">
      <div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <div class="input-group">
            <input type="date" class="datepicker form-control mb-0" id="autoSizingInputGroup" name="tanggal_lahir" value="<?php echo $pendaftar->tanggal_lahir ?>" required>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <select class="form-select" aria-label="Default select example" name="kabupaten" id="kabupaten" required>
            ...
            } else echo '<option value="' . $city['city_id'] . '" selected >' . $city['city_name'] . '</option>';
            ?>
          </select>
        </div>
      </div>
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <select class="form-select" aria-label="Default select example" name="kecamatan" id="kecamatan" required>
            ...
            } else echo '<option value="' . $district['dis_id'] . '" selected >' . $district['dis_name'] . '</option>';
            ?>
          </select>
        </div>
        ...
        <div class="col-sm-4">
          <select class="form-select" aria-label="Default select example" name="kelurahan" id="kelurahan" required>
            ...
            } else echo '<option value="' . $subdistrict['subdis_id'] . '" selected>' . $subdistrict['subdis_name'] . '</option>';
            ?>
          </select>
        </div>
      </div>
      ...
      <div class="row mb-2" id="asal_sekolah_fieldselect">
        ...
        <div class="col-sm-10" id="get-sekolah">
          <select class="form-select" aria-label="Default select example" name="asal_sekolah" id="asal_sekolah" required>
            <option id="opsi_sekolah" selected value="">.:Pilih Asal Sekolah:.</option>
            <?php
            foreach ($sekolah as $row) { 
              if ($pendaftar->asal_sekolah != null) { 
                if ($pendaftar->asal_sekolah == $row->nama_sekolah) {
                  $stat = 'selected';
                }else { 
                  $stat = '';
                }
...
<script type="text/javascript">
  function showForm(){
    ...
    var q = document.getElementById("opsi_sekolah");
    var r = document.getElementById("get-sekolah");
