...
<body class="">
    ...
    <script>
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            for (var count = 0; count < data.length; count++) {
                                ...
                                // value.push(data[count].jumlah_pendaftar);
                            }
                            // label.push(data.nama_tahap);
                            // value.push(data.jumlah_pendaftar);

                            var ctx = document.getElementById('perda').getContext('2d');
                            var chart = new Chart(ctx, {
                                type: 'bar',
                                data: {
                                    labels: ['Tahap II','Tahap III'],
                                    datasets: [{
            ...
            //     $.ajax({
            //         url: "<?php echo base_url('dynamic_dependent/get'); ?>",
            //         method: "POST",
            //         data: {
            //             periode: periode
            //         },
