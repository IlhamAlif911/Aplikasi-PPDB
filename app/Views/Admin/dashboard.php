    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card shadow-sm p-2" style="height: auto;">
                ...
                <div>
                    <canvas id="perda" style="height: auto"></canvas>
                </div>
