...
<div class="container-fluid mt-5 mb-4">
  <div class="container">
    <div class="mt-5 mb-3">
      <h2 class="">test Formulir Pendaftaran</h2>
                  ...
                  <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                    <div class="accordion-body">
                        ...
                        <div class="col-sm-4">
                          <select class="form-select" aria-label="Default select example" name="agama" id="agama" required>
                            ...
                            foreach ($agama as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('agama', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php }
                            ?>
                          </select>
                        </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="berkebutuhan_khusus" id="berkebutuhan_khusus">
                            ...
                            foreach ($berkebutuhan_khusus as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('berkebutuhan_khusus', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php }
                            ?>
                          </select>
                        </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="nomor_hp" name="nomor_hp" placeholder="No. HP" value="<?= set_value('nomor_hp') ?>" maxlength="20">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="Email" class="col-sm-2 col-form-label">Email<span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com" maxlength="50" value="<?= set_value('email') ?>" required>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pendidikan_ayah" id="pendidikan_ayah">
                            ...
                            <?php foreach ($pendidikan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pendidikan_ayah', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pekerjaan_ayah" id="pekerjaan_ayah">
                            ...
                            <?php foreach ($pekerjaan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pekerjaan_ayah', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pendidikan_ibu" id="pendidikan_ibu">
                            <option selected value="">.:Pilih Pendidikan:.</option>
                            <?php foreach ($pendidikan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pendidikan_ibu', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pekerjaan_ibu" id="pekerjaan_ibu">
                            ...
                            foreach ($pekerjaan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pekerjaan_ibu', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php }
                            ?>
                          </select>
                        </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pendidikan_wali" id="pendidikan_wali">
                            <option selected value="">.:Pilih Pendidikan:.</option>
                            <?php foreach ($pendidikan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pendidikan_wali', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="pekerjaan_wali" id="pekerjaan_wali">
                            <option selected value="">.:Pilih Pekerjaan:.</option>
                            <?php foreach ($pekerjaan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('pekerjaan_wali', $row->id, true) ?>><?= $row->nama_opsi ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                  ...
                  <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingThree">
                    <div class="accordion-body">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="asal_sekolah" name="asal_sekolah" placeholder="Asal Sekolah" maxlength="30" value="<?= set_value('asal_sekolah') ?>" required>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="jurusan" id="jurusan" required>
                            ...
                            <?php foreach ($jurusan as $row) { ?>
                              <option value="<?= $row->id ?>" <?= set_select('jurusan', $row->id, true) ?>><?= $row->nama_jurusan ?></option>;
                            <?php } ?>
                          </select>
                        </div>
                      </div>
