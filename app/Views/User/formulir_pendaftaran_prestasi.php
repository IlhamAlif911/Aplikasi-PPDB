...
<div class="container-fluid mt-5 mb-4">
    <div class="container">
        ...
        <?php endif ?>
        <form method="post" enctype="multipart/form-data" action="<?= base_url(); ?>/add-prestasi/<?= $jalur->id ?>">
            ...
            <div height="" class="stepper" id="stepper">
                <div class="steps-container">
                    <div class="steps">
                        ...
                        <div class="step" icon="fa fa-trophy" id="3">
                            <div class="step-title">
                                <span class="step-number">03</span>
                                <div class="step-text">Prestasi</div>
                            </div>
                        </div>
                        <div class="step" icon="fa fa-graduation-cap" id="4">
                            <div class="step-title">
                                <span class="step-number">04</span>
                                <div class="step-text">Beasiswa</div>
                            </div>
                        </div>
                        <div class="step" icon="fa fa-user" id="5">
                            <div class="step-title">
                ...
                <div class="stepper-content-container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($rapot as $r) : ?>
                                                <tr>
                                                    <td><?= $nomor++ ?></td>
                                                    <td width=""><input type="text" class="form-control" name="rapot[]" id="rapot" value="<?= $r->id ?>" hidden><?= $r->nama_rapot ?></td>
                                                    <td>
                                                        <input type="text" class="form-control" name="<?= $r->id ?>matematika" id="matematika" maxlength="2">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="<?= $r->id ?>ipa" id="ipa" maxlength="2">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="<?= $r->id ?>bahasa_inggris" id="bahasa_inggris" maxlength="2">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="<?= $r->id ?>bahasa_indonesia" id="bahasa_indonesia" maxlength="2">
                                                    </td>
                                                    <!--<td>
                                                        <input type="file" class="form-control" name="<?= $r->id ?>file" id="file" maxlength="2">
                                                    </td>-->
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                            ...
                            <div class="card-body">
                                ...
                                <div id="dynamic_field">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama_prestasi" name="nama_prestasi[]" placeholder="Nama Prestasi" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="Tahun" class="col-sm-2 col-form-label">Tahun</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="tahun_prestasi" name="tahun_prestasi[]" placeholder="Tahun" maxlength="5">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="Penyelenggara" class="col-sm-2 col-form-label">Penyelenggara</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="penyelenggara" name="penyelenggara[]" placeholder="Penyelenggara" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="Peringkat" class="col-sm-2 col-form-label">Peringkat</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="peringkat" name="peringkat[]" maxlength="3">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="stepper-content fade-in" stepper-label="4">
                        <div class="card border-1 bg-transparent">
                            <div class="card-body">
                                ...
                                <div id="dynamic_field_beasiswa">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="keterangan" name="keterangan[]" placeholder="Keterangan" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                            ...
                            <div class="d-flex justify-content-end flex-wrap">
                                ...
                                <div class="d-flex align-items-center m-3 border-start border-end border-top border-bottom p-3">
                                    <span class="h6 me-3">Selanjutnya</span>
                                    <div class="step btn btn-primary" icon="fa fa-arrow-right" id="5"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="stepper-content fade-in" stepper-label="5">
                        <div class="card border-1 bg-transparent">
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="d-flex align-items-center m-3 border-start border-end border-top border-bottom p-3">
                                    <div class="step btn btn-primary" icon="fa fa-arrow-left" id="4"></div>
                                    <span class="h6 me-3">Sebelumnya</span>
                                </div>
                                <div class="d-flex align-items-center m-3 border-start border-end border-top border-bottom p-3">
                                    <span class="h6 me-3">Selanjutnya</span>
                                    <div class="step btn btn-primary" icon="fa fa-arrow-right" id="6"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="stepper-content fade-in" stepper-label="6">
                        <div class="card border-1 bg-transparent">
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="d-flex align-items-center m-3 border-start border-end border-top border-bottom p-3">
                                    <div class="step btn btn-primary" icon="fa fa-arrow-left" id="5"></div>
                                    <span class="h6 me-3">Sebelumnya</span>
                                </div>
                            </div>
                        </div>
