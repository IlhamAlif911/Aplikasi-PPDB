<nav class="navbar navbar-expand-lg bg-white shadow-sm sticky-top border-bottom p-1">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?= site_url(); ?>"><img src="<?= base_url('assets/' . 'Logo.png'); ?>" style="padding-bottom: 5px;" width="40px"  alt="Logo SMK WIDYA MANDALA TAMBAK" > SMK WIDYA MANDALA TAMBAK </a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="navbar navbar-collapse collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
