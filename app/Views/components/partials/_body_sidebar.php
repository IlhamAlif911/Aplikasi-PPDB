<aside class="sidebar sidebar-default sidebar-white sidebar-base sidebar-color navs-pill" data-toggle="main-sidebar" data-sidebar="responsive" style="background-color: #4D7C0F;">
	<div class="sidebar-header d-flex align-items-center justify-content-start" style="border-bottom-color: #FFFFFF ;">
		<a href="<?= base_url(route_to('dashboard')) ?>" class="navbar-brand">
			<!--Logo start-->
			<div class="logo-main">
	...
	<div class="sidebar-body pt-0 data-scrollbar">
		<div class="sidebar-list">
			...
			<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
				...
				<li class="nav-item">
					<a class="nav-link <?= activeRoute('dashboard'); ?>" aria-current="page" href="<?= base_url(route_to('dashboard')) ?>">
				...
				<li class="nav-item">
					...
					<ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
						<li class="nav-item">
							<a class="nav-link <?= activeRoute('data-periode'); ?>" href="<?= base_url(route_to('data-periode')) ?>">
								<i class="icon">
						...
						<li class="nav-item">
							<a class="nav-link <?= activeRoute('data-tahap'); ?>" href="<?= base_url(route_to('data-tahap')) ?>">
								<i class="icon">
									<svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<g>
											<circle cx="12" cy="12" r="8" fill="currentColor"></circle>
						...
						<li class="nav-item">
							<a class="nav-link <?= activeRoute('data-jalur'); ?>" href="<?= base_url(route_to('data-jalur'))?>">
								<i class="icon">
									<svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<g>
											<circle cx="12" cy="12" r="8" fill="currentColor"></circle>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url(route_to('uisheet'))?>">
