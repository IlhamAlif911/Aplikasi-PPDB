...
{    
    public function index()
    {
        ...
        if (!$data['tahap']) {
            ...
            $html2 = '<a class="ms-3 btn btn-lg btn-primary mt-3 btn-daftar" href="'.site_url('jalur/' . $data['tahap']->id).'">Daftar Disini</a>';
            $html1 = '<a class="btn btn-light" href="'.site_url('jalur/' . $data['tahap']->id).'">Isi Disini</a>';
